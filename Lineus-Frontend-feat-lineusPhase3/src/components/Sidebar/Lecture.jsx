...
import { PANOTO, PROJECT_Map } from '../../constant';
...
const Sidebar = () => {
  ...
  const 이전버전으로이동 = () => {
    if (!PROJECT_Map[import.meta.env.VITE_PROJECT_TYPE].이전버전LMS주소) return;
    window.open(PROJECT_Map[import.meta.env.VITE_PROJECT_TYPE].이전버전LMS주소);
  };
  const goToOcw = () => {
    if (!PROJECT_Map[import.meta.env.VITE_PROJECT_TYPE].ocwAddress) return;
    window.open(PROJECT_Map[import.meta.env.VITE_PROJECT_TYPE].ocwAddress);
  };
  return (
    <>
      <div className='flex h-auto w-full flex-col gap-[10px] bg-white px-[14px] pt-[50px]'>
        <Link to='/dashboard'>
          <div
            className={`flex w-full cursor-pointer items-center gap-[8px] rounded-md px-[14px] py-2 ${
          ...
          <Link to='/dashboard/attendsetting'>
            ...
            >
              <div className='relative'>
                ...
                <svg
                  className={`absolute bottom-[1px] left-1/2 translate-x-[-50%] ${
        ...
        <div className='flex w-full cursor-pointer flex-col items-center gap-[10px]' onClick={openDropdown}>
          <div
            className={`flex w-full items-center justify-between gap-[8px] rounded-md px-[14px] py-2 ${
          ...
          <div
            className={`${
              ...
              route.pathname.includes('/dashboard/contact')
                ? 'max-h-[1000px]'
                : 'max-h-0'
            } flex w-full flex-col overflow-hidden rounded-sm bg-[#EBF1FA] px-[14px] transition-[max-height] duration-300`}
          >
            <Link to='/dashboard/notice'>
              <div className='flex flex-row items-center gap-3 py-[8px] pl-3'>
                <span
                  className={`rounded-full ${
                    route.pathname.includes('/dashboard/notice')
                      ? 'h-2 w-2 border-2 border-blue-primary'
        ...
        {import.meta.env.VITE_PROJECT_TYPE === 'KUMO' && (
          <Link onClick={이전버전으로이동}>
            <div className={`flex w-full cursor-pointer items-center gap-[8px] rounded-md px-[14px] py-2`}>
              <div className='relative'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='16'
              ...
              <span className={`text-base text-secondary`}>{t('title_footer')}</span>
            </div>
          </Link>
          ...
          //     <span
          //       className={`text 'cursor-pointer' text-primary text-sm font-bold font underline underline-offset-2 mb-[15px]`}
          //     >
          //       {t('title_footer')}
          //     </span>
          //   </div>
        ...
        {import.meta.env.VITE_PROJECT_TYPE === 'KUMO' && (
          <Link onClick={goToOcw}>
            <div className={'flex w-full cursor-pointer items-center gap-[8px] rounded-md px-[14px] py-2'}>
              ...
              <span className='text-secondary'>{t('ocw')}</span>
            </div>
          </Link>
        )}
        ...
        {user.role === 'ADMIN' && (
          <Link to='/dashboard/setting'>
            ...
            >
              ...
              <span
                className={`${
                  route.pathname.includes('/dashboard/setting') ? 'text-white' : 'text-secondary'
                } text-base`}
              >
                {t('manage_user_account')}
              </span>
        ...
        {user.role === 'ADMIN' && (
          <div className='mt-[40px] pb-[40px]'>
            <hr />
            <button className='mt-[40px] flex w-full items-center justify-center rounded-md bg-[#F3F4F6] px-[28px] py-[13px] text-blue-primary'>
              학사 동기화 버튼
            </button>
            <p className='text-xs text-primary'>{`최근 동기화 : {YYYY년 MM월 DD일}`}</p>
          </div>
        )}
      </div>
    </>
